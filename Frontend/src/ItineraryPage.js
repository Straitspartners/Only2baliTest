...
const ItineraryPage = () => {
  ...
  const confirmBooking = async () => {
    ...
    if (!journeyPreferencesId) {
      alert("Journey ID not found.");
      setLoading(false); // Hide loading state if something went wrong
      return;
    }
    ...
    try {
      ...
      sessionStorage.clear();
      setLoading(false); // Hide loading state after successful confirmation
      navigate("/dashboardpreferences"); // Redirect after confirmation
    } catch (error) {
      console.error("Error confirming journey:", error);
      alert("Error confirming journey. Please try again.");
  ...
  return (
    <div className="it-container">
      ...
      <div className="it-content">
        ...
        {/* Loading Overlay for Booking Confirmation */}
        {loading && (
          <div style={styles.loadingOverlay}>
            <div style={styles.loadingText}>Confirming your journey...</div>
          </div>
        )}
