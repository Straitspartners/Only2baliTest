...
const BalineseAdventureForm = () => {
  ...
  const fetchAirports = async () => {
    try {
      // Fetch airport data (assuming an API like AviationStack)
      ...
      const indiaAirports = response.data.data.filter(airport => airport.country_name === "Indonesia");
