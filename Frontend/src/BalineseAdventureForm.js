// corrected code after the airport dropdown
...
const BalineseAdventureForm = () => {
  ...
  const handleSelectChange = (selectedOption) => {
    setFormData((prev) => ({
      ...prev,
      international_airport: selectedOption ? selectedOption.value : "",
    }));
  };
  ...
  <Select
    ...
    styles={{
      ...
      input: (provided) => ({
        ...provided,
        minWidth: "350px", // Minimum width while typing
      }),
